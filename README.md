...
### 1. Clone Repository
```bash
git clone https://github.com/yourusername/physical-ai-textbook.git # Replace with your repo
cd physical-ai-textbook
```

### 2. Frontend Setup
```bash
cd physical-ai-textbook # Navigate to the Docusaurus project root
npm install
cp .env.example .env
...
*   Implementation Plan: `specs/textbook-generation/plan.md`
*   Task Breakdown: `specs/textbook-generation/tasks.md`
*   Data Model: `specs/textbook-generation/data-model.md`
*   API Contracts: `specs/textbook-generation/contracts/`
*   Quickstart Guide: `specs/textbook-generation/quickstart.md`
...
*   Follow task structure in `specs/textbook-generation/tasks.md`
*   Run tests: `npm test` (frontend), `pytest tests/` (backend)
...
```bash
# Frontend
cd physical-ai-textbook && npm install && npm start
# Visit: http://localhost:3000

# Backend (Mock Server)
cd rag_chatbot && python simple_server.py
# Visit: http://localhost:8000
```

Next Steps for Production:

*   Review `PRODUCTION_CHECKLIST.md` for complete deployment guide
*   Set up Qdrant Community Cloud account
